...
const ProductTable = (props) => {
  ...
  function addToCart(data){
    if(!loginStatus){
      ...
      axios.post("https://theshopaholicstore.com/api/auth/addToCart", data).then((response) => {
...
function Products() {
  ...
  const onSubmit = (data) => {
      console.log("hello")
      axios.post("https://theshopaholicstore.com/api/products/bySearch", data).then((response) => {
    ...
    return (
      <div className="Products">
          ...
          <ProductTable2 products={listOutofStock}/>
