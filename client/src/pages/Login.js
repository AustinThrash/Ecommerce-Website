...
function Login() {
    ...
    const onSubmit = (data) => {
        ...
        axios.post("https://theshopaholicstore.com/api/auth/login", data, {withCredentials: true ,headers: {
      'Access-Control-Allow-Origin': 'https://theshopaholicstore.com',
      'Content-Type': 'application/json',
          ...
          if (!response.data.error) {
            ...
            if (response.data.user == "admin@gmail.com") {
              navigate("/admin")
