...
function Cart() {
    ...
    const onSubmit = (data) => {
      ...
      console.log(data)
        ...
        axios.post("https://theshopaholicstore.com/api/products/updateStock",listOftest.data).then((response) => {
          if(response.data == "updated"){
            ...
            axios.post("https://theshopaholicstore.com/api/auth/placeOrder", {
    ...
    useEffect(() => {
      ...
      axios.get("https://theshopaholicstore.com/api/products").then((response) => {
        ...
        axios({
          method: 'post',
          url: 'https://theshopaholicstore.com/api/auth/getCart',
          data: {
            id: `${id}`,
          }
          }).then((response) => {
    ...
    function removeItem(data) {
      axios.post("https://theshopaholicstore.com/api/auth/removeItem", data).then((response) => {
            //console.log(response)
            if(response.data == "Success") {
    ...
    function applyCoupon() {
      ...
      if(appliedCoupon){
        ...
        axios.post("https://theshopaholicstore.com/api/products/checkCoupon", data).then((response) => {
            console.log(response)
            if(response.data[0]) {
